...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/0.14.1/dist/wheels/bokeh-2.4.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/0.14.1/dist/wheels/panel-0.14.1-py3-none-any.whl', 'pyodide-http==0.1.0', 'holoviews>=1.15.1', 'numba', 'numpy', 'pandas', 'scipy']
...
def get_stocks():
    if file_input.value is None:
        stock_file = "https://raw.githubusercontent.com/firobeid/firobeid.github.io/main/docs/portfolio-optimizer/Resources/stocks.csv"
    else:
        stock_file = BytesIO()
